...
#include "SimpleSystem_ee_internal.inc"
#include "SimpleSystem_ee_irq.inc"
//~ #include "SimpleSystem_cortex_mx_ee_nvic.inc"
#include "cyfitter.h"
#include "cylib.h"
...
#error  The Interrupt isr_Button could not be found. Make sure the name in the OS config exactly matches the name of the interrupt in the interrupt tab.
	...
	NVIC_SET_PRI(isr_Timer__INTC_NUMBER, (ISR_MIN_PRI - 14));
