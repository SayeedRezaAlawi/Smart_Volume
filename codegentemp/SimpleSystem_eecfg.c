 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_4[TASK_4_STACK_SIZE];	/* Task 4 (tsk_sevenSet) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_4_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_4[(TASK_4_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_sevenSet*/
        #endif
        #ifdef TASK_5_STACK_SIZE
...
#define MAX_PRIORITY 0x80U
    ...
    EE_TYPEPRIO EE_rq_link[EE_MAX_TASK] =
        { 
        #include "SimpleSystem_task_priorities.inc"
            #if EE_MAX_TASK > 0
            TSK1_PRI
            #endif
            #if EE_MAX_TASK > 1
 ...
 **************************************************************************/
    ...
    */
    EE_TYPEBOOL EE_resource_locked[EE_MAX_RESOURCE] =
        ...
        #include "SimpleSystem_resource_priorities.inc"
