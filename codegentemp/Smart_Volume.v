// ======================================================================
// Smart_Volume.v generated from TopDesign.cysch
// 01/22/2020 at 11:15
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=3, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=1, CONTROL3=1, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InitCounterValue=500, InterruptOnCapture=false, InterruptOnCompare=true, InterruptOnOverUnderFlow=false, InterruptOnTC=true, Period=500, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=true, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=SOUND_SAMPLE, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SOUND_SAMPLE, CY_INSTANCE_SHORT_NAME=SOUND_SAMPLE, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=SOUND_SAMPLE, )
...
module top ;
    ...
    UART_v2_50_0 UART_LOG (
        ...
        .reset(1'b0),
        .rx(Net_2535),
        .tx_interrupt(Net_2536),
        .rx_interrupt(Net_2537),
        .tx_data(Net_2538),
        .tx_clk(Net_2539),
        .rx_data(Net_2540),
        .rx_clk(Net_2541));
    ...
    PWM_v3_30_4 SOUND_PWM (
        ...
        .ph1(Net_2590),
        .ph2(Net_2591));
    defparam SOUND_PWM.Resolution = 8;


	cy_clock_v1_0
		#(.id("a4902921-435a-44f9-976f-e67c6f83a14c"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("40000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__SOUND_MUX_0_net;
	wire [0:0] tmpFB_0__SOUND_MUX_0_net;
	wire [0:0] tmpIO_0__SOUND_MUX_0_net;
	wire [0:0] tmpINTERRUPT_0__SOUND_MUX_0_net;
	electrical [0:0] tmpSIOVREF__SOUND_MUX_0_net;

	cy_psoc3_pins_v1_10
		#(.id("eebd29f8-2ab7-47f3-8df8-1629de0891dd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SOUND_MUX_0
		 (.oe(tmpOE__SOUND_MUX_0_net),
		  .y({Net_2593}),
		  .fb({tmpFB_0__SOUND_MUX_0_net[0:0]}),
		  .io({tmpIO_0__SOUND_MUX_0_net[0:0]}),
		  .siovref(tmpSIOVREF__SOUND_MUX_0_net),
		  .interrupt({tmpINTERRUPT_0__SOUND_MUX_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SOUND_MUX_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SOUND_MUX_1_net;
	wire [0:0] tmpFB_0__SOUND_MUX_1_net;
	wire [0:0] tmpIO_0__SOUND_MUX_1_net;
	wire [0:0] tmpINTERRUPT_0__SOUND_MUX_1_net;
	electrical [0:0] tmpSIOVREF__SOUND_MUX_1_net;

	cy_psoc3_pins_v1_10
		#(.id("fab0f2ca-06b3-4c00-a6cb-602cba004095"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SOUND_MUX_1
		 (.oe(tmpOE__SOUND_MUX_1_net),
		  .y({Net_2594}),
		  .fb({tmpFB_0__SOUND_MUX_1_net[0:0]}),
		  .io({tmpIO_0__SOUND_MUX_1_net[0:0]}),
		  .siovref(tmpSIOVREF__SOUND_MUX_1_net),
		  .interrupt({tmpINTERRUPT_0__SOUND_MUX_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SOUND_MUX_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 SOUND_Control (
        .control_1(Net_2594),
        .control_2(Net_2595),
        .control_3(Net_2596),
        .control_0(Net_2593),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam SOUND_Control.Bit0Mode = 0;
    defparam SOUND_Control.Bit1Mode = 0;
    defparam SOUND_Control.Bit2Mode = 0;
    defparam SOUND_Control.Bit3Mode = 0;
    defparam SOUND_Control.Bit4Mode = 0;
    defparam SOUND_Control.Bit5Mode = 0;
    defparam SOUND_Control.Bit6Mode = 0;
    defparam SOUND_Control.Bit7Mode = 0;
    defparam SOUND_Control.BitValue = 0;
    defparam SOUND_Control.BusDisplay = 0;
    defparam SOUND_Control.ExtrReset = 0;
    defparam SOUND_Control.NumOutputs = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("a4b42786-207f-4c90-9618-cb255ceabdee"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SOUND_ENABLE_net;
	wire [0:0] tmpFB_0__SOUND_ENABLE_net;
	wire [0:0] tmpIO_0__SOUND_ENABLE_net;
	wire [0:0] tmpINTERRUPT_0__SOUND_ENABLE_net;
	electrical [0:0] tmpSIOVREF__SOUND_ENABLE_net;

	cy_psoc3_pins_v1_10
		#(.id("9d12849b-e42f-4b8c-9017-07e72824d950"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SOUND_ENABLE
		 (.oe(tmpOE__SOUND_ENABLE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SOUND_ENABLE_net[0:0]}),
		  .io({tmpIO_0__SOUND_ENABLE_net[0:0]}),
		  .siovref(tmpSIOVREF__SOUND_ENABLE_net),
		  .interrupt({tmpINTERRUPT_0__SOUND_ENABLE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SOUND_ENABLE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Counter_v3_0_5 SOUND_SAMPLE (
        .reset(Net_35),
        .tc(Net_35),
        .comp(Net_2603),
        .clock(Net_2504),
        ...
        .up_ndown(1'b1),
        .count(1'b0));
    defparam SOUND_SAMPLE.CaptureMode = 0;
    defparam SOUND_SAMPLE.ClockMode = 3;
    defparam SOUND_SAMPLE.CompareMode = 1;
    defparam SOUND_SAMPLE.CompareStatusEdgeSense = 1;
    defparam SOUND_SAMPLE.EnableMode = 0;
    defparam SOUND_SAMPLE.ReloadOnCapture = 0;
    defparam SOUND_SAMPLE.ReloadOnCompare = 1;
    defparam SOUND_SAMPLE.ReloadOnOverUnder = 1;
    defparam SOUND_SAMPLE.ReloadOnReset = 1;
    defparam SOUND_SAMPLE.Resolution = 16;
    defparam SOUND_SAMPLE.RunMode = 0;
    defparam SOUND_SAMPLE.UseInterrupt = 1;


	cy_clock_v1_0
		#(.id("393c92b0-0e83-4a28-8619-29da9389c96e"),
		  .source_clock_id(""),
		  .divisor(0),
