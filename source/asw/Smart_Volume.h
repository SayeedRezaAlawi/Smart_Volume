...
#ifndef SMART_VOLUME_H
#define SMART_VOLUME_H
...
*/
enum VOLUME__IncreamentState{
    VOLUME__NormalIncreament,
    VOLUME__FastIncreament,
    VOLUME__VeryFastIncreament,
} ;
typedef enum VOLUME__IncreamentState VOLUME__IncreamentState_t;

enum VOLUME__DecreamentState{
    VOLUME__NormalDecreament,
    VOLUME__FastDecreament,
    VOLUME__VeryFastDecreament,
} ;
typedef enum VOLUME__DecreamentState VOLUME__DecreamentState_t;
 ...
 * /return volume value.
 */
uint8_t MP3__increaseSmartVolume(EventMaskType nextEvent);         /**< \brief increase the volume by one */

/**
 * decreasing the volume based on different events.
 * /return volume value
 */
uint8_t MP3__decreaseSmartVolume(EventMaskType nextEvent);         /**< \brief decrease the volume by one */
